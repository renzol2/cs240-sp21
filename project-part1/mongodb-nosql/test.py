...
def pytest_sessionstart():
    ...
    proc_mongo = subprocess.Popen(['docker', 'run', '--rm', '-it', '-p', '27017:27017', 'mongo'])
    proc_mongo.wait()


def test_mp_overview_mongo(test_client):
    import json
...
def test_new_key_mongo(test_client):
    import json
...
def test_memory_mongo(test_client):
    import json
    import random
...
def test_delete_mongo(test_client):
    import json
